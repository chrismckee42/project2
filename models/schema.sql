...
INSERT INTO monsters (name, hp, attack, location_id)
VALUES 	("Troll", 10, 3, 1),
		("Goblin", 3, 1, 8),
		("Owlbear", 6, 2, 4),
		("Bandit", 5, 2, 3);
        
INSERT INTO treasure (name, amount, location_id)
VALUES 	("Emerald Knife", 20, 7),
		("Jeweled Crown", 50, 9);
        
INSERT INTO treasure (name, amount, monster_id)
VALUES 	("Bag of Copper Coins", 5, 2),
		("Silver Chalice", 40, 1),
		("Chest of loot", 100, 4);
